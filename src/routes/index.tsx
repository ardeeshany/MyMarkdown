            ...
            <section className="frosted-surface overflow-hidden rounded-2xl ring-1 ring-card/80">
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border/70 bg-glass px-3 py-2.5 sm:px-4">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Button type="button" size="sm" variant="outline" onClick={beautify} className="bg-background text-primary hover:text-primary hover:bg-background hover:border-foreground"><Sparkles className="text-primary" />Beautify</Button>
                </div>
              </div>
