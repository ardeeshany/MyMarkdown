    ...
    <main className="relative min-h-screen overflow-x-clip bg-background px-5 pb-32 pt-12 font-ui text-foreground sm:px-8 sm:pt-10">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <header className="flex flex-col items-center text-center">
          ...
          <span className="mt-4 inline-flex items-center gap-1.5 rounded-md border border-muted-foreground/50 px-2.5 py-1 text-[11px] font-medium uppercase tracking-[0.14em] text-muted-foreground">
