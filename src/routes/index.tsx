...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://mymarkdown.site/__l5e/assets-v1/01e54db9-2152-46a2-8cab-ae3f48b8ddbb/mymarkdown-share.png" },
      ...
      { name: "twitter:image", content: "https://mymarkdown.site/__l5e/assets-v1/01e54db9-2152-46a2-8cab-ae3f48b8ddbb/mymarkdown-share.png" },
    ],
    ...
    <main className="relative min-h-screen overflow-x-clip bg-background px-5 pb-16 pt-8 text-foreground sm:px-8 sm:pt-10">
      ...
      <div className="relative mx-auto max-w-6xl">
        <header className="flex flex-col items-center text-center">
          <img src={heroIcon} alt="MyMarkdown icon" className="mb-3 size-32 sm:size-40" draggable={false} />
